 ...
 */
export declare function mayStartWarmRequest(input: WarmGateInput, now: number): boolean;
/**
 ...
 */
export declare function createWarmRequest(snapshot: GenerateOptions, signal: AbortSignal): GenerateOptions;
/**
 ...
 */
export declare function retryBackoffMs(intervalMs: number, retryAfterMs: number | undefined): number;
/**
 ...
 */
export declare function nextAttemptDelayMs(intervalMs: number, retryAfterMs: number | undefined): number;
